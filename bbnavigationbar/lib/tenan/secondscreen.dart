...
//    ];
    ...
    _playerDateRanking = {
      DateTime(2018, 9, 10): [
        PlayerRanking('Tony', 2, 6, 140, 110, 80),
        PlayerRanking('John', 1, 2, 120, 130, 56),
        PlayerRanking('Mike', 5, 5, 120, 130, 70),
        PlayerRanking('Clar', 3, 2, 100, 134, 63)
      ],
      DateTime(2018, 9, 12): [
        PlayerRanking('Tony', 2, 6, 140, 110, 80),
        PlayerRanking('John', 1, 2, 120, 130, 56),
...
class _RankingTableState extends State<RankingTable> {
  ...
  DataTable buildRankingTable() {
    ...
    return DataTable(
      columns: <DataColumn>[
        DataColumn(label: Text('No_transaksi')),
